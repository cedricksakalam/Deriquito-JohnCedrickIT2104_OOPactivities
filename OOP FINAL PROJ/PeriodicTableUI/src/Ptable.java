...
public class Ptable {
    ...
    public static void main(String[] args) {
        ...
        // Create the main panel to hold both the data and the button
        JPanel mainPanel = new JPanel();
        mainPanel.setLayout(new BorderLayout());  // Use BorderLayout to manage the button and data

        // Create the panel to hold the data
        ...
        // Data for the periodic table (sample data)
        Object[][] elements = {
            {"Hydrogen", 1, 1.008, "H"},
            {"Helium", 2, 4.0026, "He"},
            {"Lithium", 3, 6.94, "Li"},
        ...
        // Add the data panel to the scroll pane
        JScrollPane scrollPane = new JScrollPane(panel);

        // Add the scroll pane to the main panel (top section)
        ...
        backButton.addActionListener(e -> {
            // When the button is clicked, call a function from another class
            PeriodicTableGame game = new PeriodicTableGame();
        
        // Set the game window visible
            game.setVisible(true); // Calling the method in AnotherClass
            frame.dispose();  // Optionally close the current frame
        });

        // Add the "Back" button to the bottom of the frame (using BorderLayout.SOUTH)
